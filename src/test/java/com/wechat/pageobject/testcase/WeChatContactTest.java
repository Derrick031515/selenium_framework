...
//            cookies.forEach(cookie-> System.out.println(cookie.getName()+":"+cookie.getValue()));
    ...
    @Description("企业微信项目")
    @Story("通讯录")
    @DisplayName("通讯录添加子部门功能")
    @ParameterizedTest
    @MethodSource("getTestCaseData")
    @Tag("test")
    @Order(1)
    public void addDepartment(POBaseData poBaseData) {
        //获取当前方法名称
    ...
    @Description("企业微信项目")
    @Story("通讯录")
    @DisplayName("通讯录删除子部门功能")
    @ParameterizedTest
    @MethodSource("getTestCaseData")
    @Tag("test")
    @Order(4)
    public void deleteDepartment(POBaseData poBaseData) {
        //获取当前方法名称
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
        startMethod(poBaseData,methodName,baseTestCaseExcutor,driver);
    }
    ...
    @Description("企业微信项目")
    @Story("通讯录")
    @DisplayName("通讯录更新子部门功能")
    @ParameterizedTest
    @MethodSource("getTestCaseData")
    @Tag("test")
    @Order(3)
    public void updateDepartment(POBaseData poBaseData) {
        //获取当前方法名称
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
        startMethod(poBaseData,methodName,baseTestCaseExcutor,driver);
    }
    ...
    @Description("企业微信项目")
    @Story("通讯录")
    @DisplayName("通讯录查询子部门功能")
    @ParameterizedTest
    @MethodSource("getTestCaseData")
    @Tag("test")
    @Order(2)
    public void searchDepartment(POBaseData poBaseData) {
        //获取当前方法名称
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
        startMethod(poBaseData,methodName,baseTestCaseExcutor,driver);
    }
    ...
    @Description("企业微信项目")
    @Story("通讯录")
    @DisplayName("通讯录添加子部门成员功能")
    @ParameterizedTest
    @MethodSource("getTestCaseData")
    @Tag("test")
    @Order(5)
    public void addDepartmentMember(POBaseData poBaseData) {
        //获取当前方法名称
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
        startMethod(poBaseData,methodName,baseTestCaseExcutor,driver);
    }
    ...
    @Description("企业微信项目")
    @Story("通讯录")
    @DisplayName("通讯录删除子部门成员功能")
    @ParameterizedTest
    @MethodSource("getTestCaseData")
    @Tag("test")
//    @Order(1)
    @Disabled
    public void deleteDepartmentMember(POBaseData poBaseData) {
        //获取当前方法名称
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
        startMethod(poBaseData,methodName,baseTestCaseExcutor,driver);
    }
    ...
    @Description("企业微信项目")
    @Story("通讯录")
    @DisplayName("通讯录更新子部门成员功能")
    @ParameterizedTest
    @MethodSource("getTestCaseData")
//    @Tag("test")
    @Disabled
    public void updateDepartmentMember(POBaseData poBaseData) {
        //获取当前方法名称
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
        startMethod(poBaseData,methodName,baseTestCaseExcutor,driver);
    }
    ...
    @Description("企业微信项目")
    @Story("通讯录")
    @DisplayName("通讯录查询子部门成员功能")
    @ParameterizedTest
    @MethodSource("getTestCaseData")
//    @Tag("test")
    @Disabled
    public void searchDepartmentMember(POBaseData poBaseData) {
        //获取当前方法名称
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
        startMethod(poBaseData,methodName,baseTestCaseExcutor,driver);
    }
