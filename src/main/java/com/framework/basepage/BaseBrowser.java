...
public class BaseBrowser {
    static Logger log = LoggerFactory.getLogger(BaseBrowser.class);
    /**
     * 驱动
     */
     ...
     * 构造器 2
     */
    public BaseBrowser(WebDriver driver) throws IOException {
        this.driver = driver;
     ...
     */
    public BaseBrowser(WebDriver driver,RedisUtil redisUtil) throws IOException {
        this.driver = driver;
        this.actions = new Actions(driver);
        this.je = ((JavascriptExecutor) driver);
        // 显示等待时长
...
*/
     ...
     */
    public WebDriver switchHandleByTitle(WebDriver driver,String title) throws Exception {
        // 当前窗口句柄
        String currentHandle = driver.getWindowHandle();
        // 所有窗口句柄
        Set<String> allHandlesSet = driver.getWindowHandles();
